...
x5engine.imQueue.push_init("x5engine.imMenu.setup({ target: '#imMnMn', verticalScroll: true, orientation: 'horizontal', menuHeight: 30, submenuHeight: 23, opacity: 1.000, type: 'singleColumn', effect: 'fade'})",false);
